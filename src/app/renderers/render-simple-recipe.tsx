...
import { Recipe, Ingredient } from '../model/simple-recipe'
    ...
    <section className="items">
      ...
      <ul className="checkmark">
        {recipe.ingredients.map(ingredient => <li>
          <span className="ingredient">{ingredient.name}</span>&nbsp;<span className="amount">{ingredient.quantity}{ingredient.unit}</span>
        </li>)}
      </ul>
    </section>
  </article>
